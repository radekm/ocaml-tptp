...
(* OASIS_START *)
(* DO NOT EDIT (digest: e425a81249b169c804b6e2b914477fb8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = ["(c) 2012-2014 Radek Micek"];
          maintainers = [];
          authors = ["Radek Micek"];
          homepage = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "tptp is a library for reading and writing FOF and CNF formulas in TPTP format. Library can process all problems and axioms from TPTP 6.0.0 which don't contain line starting with \"thf(\" or \"tff(\"."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "I\131\168Q\175\148\249;c\028?\005\229\r\220\238";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
