...
(* OASIS_START *)
(* DO NOT EDIT (digest: 86555d8f4bb011d4e3872477d981203d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "tptp is a library for reading and writing FOF and CNF formulas in TPTP format. Library can process all problems and axioms from TPTP 6.2.0 which don't contain line starting with \"thf(\" or \"tff(\"."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "pmeA(@9\217\142\231\135\143\203\150\168\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
