...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1cb1320488b0e31292ade6e9e3708af4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "tptp is a library for reading and writing FOF and CNF formulas in TPTP format. Library can process all TPTP problems which don't contain line starting with \"thf(\" or \"tff(\"."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "+\198\136o\181}\160!F\186p\168\026\150No";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
