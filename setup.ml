...
(* OASIS_START *)
(* DO NOT EDIT (digest: bfdd39c976560e44e5a82dda5e6fa95f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "tptp is a library for reading and writing FOF and CNF formulas in TPTP format. Library can process all problems and axioms from TPTP 6.1.0 which don't contain line starting with \"thf(\" or \"tff(\"."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "3\004\tJ\029n/\200\141\145\005\212\031z\b\031";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
