...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01f90246b1ad0ddf3fdc10d13c873b69) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = ["(c) 2012-2013 Radek Micek"];
          maintainers = [];
          authors = ["Radek Micek"];
          homepage = None;
          ...
          description =
            Some
              "tptp is a library for reading and writing FOF and CNF formulas\nin TPTP format. Library can process all TPTP problems which don't\ncontain line starting with \"thf(\" or \"tff(\".";
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "-C8\nr\177\243\023\171\175\202>\201,\181\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
