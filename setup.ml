...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3f4ea44bd76c2ed90c2cd5ba1b4a265b) *)
(*
...
let setup_t =
  {
     ...
     doc = [("api-tptp", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("api-tptp", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          description =
            Some
              "tptp is library for parsing FOF and CNF formulas from TPTP format.\nLibrary can parse all TPTP problems which don't contain line\nstarting with \"thf(\" or \"tff(\".";
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Tptp_ast"; "Tptp_parser"; "Tptp_lexer"; "Tptp"];
                      lib_pack = false;
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for TPTP";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\241\134\138\1970r\176\191{2\201}r\007\212\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
